				...
				<form action="">
					<div class="rows p-3">
						...
						<div class="col-2">
							...
							<input type="number" id="qtde" name="qtde" value="1" class="form-campo">
						</div>
						<div class="col-2">
							<span class="text-label">Valor</span>
							<input type="text" id="valor" name="valor" value="100,00" class="form-campo">
						</div>
				...
				<div class="border-bottom-0">
					...
					<?php foreach($itens as $item) {  ?>
							<tr class="ativo">
								...
								<td align="center"><?php echo $item->preco ?></td>
								<td align="center"><?php echo $item->qtde ?></td>
								<td align="center">R$<?php echo $item->subtotal ?></td>
								<td align="center"><a href="javascript:;" onclick="return excluir(this)"data-entidade="item" data-id="<?php echo $item->id_item ?>"
								 class="btn btn-outline-vermelho" >Excluir</a></td>
							</tr>
					<?php } ?>
						</tbody>
					</table>
